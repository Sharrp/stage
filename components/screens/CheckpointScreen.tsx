  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-900 to-slate-950 text-white">
      ...
      <div className="border-b border-slate-800 px-8 py-6">
        ...
        <p className="text-sm text-slate-400 mt-2">Your input shapes the pricing model we build</p>
      </div>
        ...
        >
          ...
          <div className="rounded-lg border border-slate-700 bg-slate-800 p-6">
            <div className="flex items-start gap-3 mb-4">
              ...
              <div>
                <p className="text-xs uppercase font-semibold text-slate-400 mb-2">What System Just Found</p>
                <p className="text-sm leading-relaxed">{mockCheckpoint.context}</p>
              </div>
            </div>
          </div>
          ...
          {/* Question */}
          <div>
            <h2 className="text-2xl font-bold mb-6">{mockCheckpoint.question}</h2>
            ...
            {/* Impact Preview */}
            <div className="rounded-lg border border-orange-500/30 bg-orange-500/10 p-4 mb-8">
              <p className="text-xs uppercase font-semibold text-orange-400 mb-2">Impact</p>
              <p className="text-sm text-orange-200">{mockCheckpoint.impact}</p>
            </div>

            {/* Confidence & Data Used */}
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
              <div className="rounded-lg border border-slate-700 bg-slate-800 p-4">
                <p className="text-xs uppercase font-semibold text-slate-400 mb-2">Confidence Level</p>
                <div className="flex items-end gap-2">
                  <p className="text-3xl font-bold text-blue-400">{Math.round(mockCheckpoint.confidence * 100)}%</p>
                  <p className="text-xs text-slate-500 mb-1">based on available data</p>
                </div>
              </div>

              <div className="rounded-lg border border-slate-700 bg-slate-800 p-4">
                <p className="text-xs uppercase font-semibold text-slate-400 mb-3">Data Used</p>
          ...
          {!showPause ? (
            ...
            <div className="rounded-lg border border-slate-700 bg-slate-800 p-6">
              <p className="font-semibold mb-4">When you&apos;re ready, come back to this decision.</p>
              ...
              <button
                onClick={handlePause}
                className="w-full rounded-lg border border-slate-600 px-6 py-3 font-medium text-white hover:bg-slate-800 transition-all"
              >
