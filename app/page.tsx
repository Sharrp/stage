        ...
        {!loading && !user && (
          <div className="flex justify-center mt-8">
            <button
              ...
              disabled={signingIn}
              className="px-6 py-3 bg-[#fb607f] hover:bg-[#ff7a9a] text-white font-bold rounded flex items-center justify-center gap-3 min-w-[250px] disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
            >
